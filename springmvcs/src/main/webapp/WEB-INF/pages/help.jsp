...
<!--<![endif]--><head>
    ...
    <meta name="keywords" content="免费高匿代理IP,全网代理IP,动态代理IP,私密代理ip,http代理,代理ip,私密代理ip,爬虫代理ip,刷单代理ip,随机五位端口IP,独享代理ip,花刺代理ip,ip代理软件,免费代理ip,高匿代理ip,最新代理ip,代理api接口,代理ip购买,api代理IP" />
    <meta name="description" content="全网代理IP是一家以代理IP为主营业务的IDC服务商，每天高匿代理IP流水超过50万，旗下产品包括普通代理IP、动态代理IP；所有代理IP均为自营产品，保证稳定性和时效性；服务企业超过8000家。全网代理IP每天提供实时更新的免费代理IP，同时提供API数据接口和支持自动换IP的全网代理IP切换精灵软件。" /><title>帮助中心_全网代理IP_免费代理IP_私密动态代理ip_换IP软件_购买API接口_高匿代理IP</title>
    ...
    <link rel="stylesheet" type="text/css" href="http://www.goubanjia.com/theme/goubanjia/css/index.min.css?v=1.4"></head>
<body>
...
<div style="background: #0074a2; height: 35px; line-height: 35px; width: 100%; font-size: 12px; font-weight: 900;">
    <div class="wrap">
        <div style="float: left;">
            ...
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" target="_blank" title="独享代理IP" href="http://vipip.goubanjia.com/cn.html">独享长效代理IP</a>
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" target="_blank" title="动态代理IP" href="http://vipip.goubanjia.com/dynamic.html">动态代理IP</a>
        </div>
        <div style="float: right;">
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" href="http://www.goubanjia.com/user/login.shtml">登录</a>
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" href="http://www.goubanjia.com/user/register.shtml">注册</a>
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" target="_blank" href="http://www.goubanjia.com/user/agree.shtml">服务条款</a>
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" title="帮助中心" href="http://www.goubanjia.com/help/index.shtml">帮助中心</a>
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" title="代理知识库" href="http://www.goubanjia.com/article/index.shtml">知识库</a>
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" title="每日IP更新" href="http://www.goubanjia.com/dayip_1.shtml">每日IP更新</a>
            <a style="color: #fff;text-decoration: none;padding: 0 6px;" title="IP地区分布" href="http://www.goubanjia.com/info/index.html">IP实时分布</a>
        </div>
    </div>
</div>
...
<div id="page-header" class="wrap header" style="margin-top: 0px;">
    <header id="masthead" class="site-header" role="banner">
        ...
        <div class="site-social" style="width: auto;">
            今日本站已扫描代理总数: <strong>682120</strong><span class="message">（57秒前更新）</span><br>
            30分钟内检测可用代理数: <strong style="cursor: pointer;" onclick="window.open('http://www.goubanjia.com/info/index.shtml','_blank')">6890</strong><span class="message">（3分钟前更新）</span>
        </div>
        <!-- start image header -->
        <div class="clear"></div>
    </header>
...
<script type="text/javascript">
    document.getElementById('menu_help').setAttribute("class", "menu-item menu-item-type-custom menu-item-object-custom current-menu-item");
    document.getElementById('menu_help').setAttribute("href", "#");
</script><!-- start content -->
<div class="wrap fullwidth">
    <div id="content" style="width: auto;">

        <div id="breadcrumbs">
            <a href="http://www.goubanjia.com/">首页</a>&raquo;&raquo;&nbsp; 帮助中心
            <span class="right smallbutton">
    				<a class="right" href="http://www.goubanjia.com/article/">代理知识库</a>
    			</span>
        </div>
            ...
            <div class="entry entry-content">
                ...
                <div class="questions">
                    <div class="line">
                        ...
                        <div class="answer">
                            您可以购买包天试用，支付宝担保支付，我们支持<span class="warn">24小时全额退款</span>。 <a href="http://www.goubanjia.com/buy/" target="_blank">去购买>></a>
                        </div>
                    </div>
                    ...
                    <div class="line">
                        <h3>6. 你们都有哪些地区的代理？</h3>
                        <div class="answer">
                            我们实时可用的代理覆盖<span class="warn"> 超过60个国家 </span>，中国国内覆盖<span class="warn"> 超过26个省 </span>。<a href="http://www.goubanjia.com/info/#dist_country" target="_blank">查看地区实时分布>></a>
                        </div>
                    </div>
                    <div class="line">
                        <h3>7. 你们有https代理吗？</h3>
                        <div class="answer">
                            有的，请在提取代理时按<span class="warn"> https </span>筛选。<a href="http://www.goubanjia.com/fetch/" target="_blank">去提取>></a>
                        </div>
                    </div>
                    <div class="line">
                        <h3>8. 如何只提取国内代理？</h3>
                        <div class="answer">
                            筛选条件中的“所在地区” 填写 <span class="warn"> 中国 </span>。<a href="http://www.goubanjia.com/fetch/" target="_blank">去提取>></a>
                        </div>
                    </div>
                    <div class="line">
                        <h3>9. 如何只提取国外代理？</h3>
                        <div class="answer">
                            筛选条件中的“排除地区” 填写 <span class="warn"> 中国 </span>。<a href="http://www.goubanjia.com/fetch/" target="_blank">去提取>></a>
                        </div>
                    </div>
                    <div class="line">
                        <h3>10. 你们代理都是高匿名的吗？</h3>
                        <div class="answer">
                            不是，HTTP代理按匿名度可分为透明代理、匿名代理和高度匿名代理，我们实时可用的代理中3种类型都包含。<a href="http://www.goubanjia.com/info/#dist_anonymity" target="_blank">查看匿名度实时分布>></a>
                        </div>
                    </div>
                    <div class="line">
                        <h3>11. 为什么我的订单被封禁？</h3>
                        <div class="answer">
                            ...
                            API接口调用频率限制为<span class="warn">最多1秒钟调用1次 </span>，请遵循如下调用原则：<br>
                            ...
                            （调用修正后订单会在<span class="warn"> 15分钟内 </span>自动解封）
                        </div>
                    </div>
                    ...
                    <div class="line">
                        <h3>15. 付款时收货信息如何填写？</h3>
                        <div class="answer">
                            收货信息可以随便填。
                        </div>
                    </div>
                    <div class="line" id="q_lasttime">
                        <h3>16. 什么是代理的最后检测时间？</h3>
                        <div class="answer">
                            最后一次测试代理IP可用的时间。<br>
                        </div>
                    </div>
    ...
    <div id="footer">
		...
		<span class="footerleft">友情链接：
			<a href="http://proxy.goubanjia.com/" target="_blank" title="全网代理IP">全网代理IP</a>
			<a href="http://vipip.goubanjia.com/" target="_blank" title="长效独享高匿代理IP">独享高匿IP</a>
		</span>
            <div class="clear"></div>
        </div>
...
<!-- start credits -->
<div class="credits">
    © 2015  版权所有 &nbsp;&nbsp;QQ交流群：66782959&nbsp;&nbsp;<a href="http://www.goubanjia.com/dayip_1.shtml" target="_blank">每日免费分享</a>&nbsp;&nbsp;<a href="http://www.goubanjia.com/article/">代理知识库</a>&nbsp; &nbsp;<a title="网站服务条款" target="_blank" href="http://www.goubanjia.com/user/agree.html">服务条款</a>
    <br><br>
